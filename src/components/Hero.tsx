  ...
  return (
    <header class="relative bg-gradient-to-br from-slate-50 via-blue-50 to-white overflow-hidden min-h-screen flex items-center">
      ...
      <div class="max-w-6xl mx-auto px-6 sm:px-12 py-16 md:py-20 text-center relative z-20">
        ...
        <h1 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight text-gray-900 md:text-white md:drop-shadow-[0_8px_16px_rgba(0,196,204,0.85)] md:drop-shadow-[0_25px_25px_rgba(59,130,246,0.55)]">
