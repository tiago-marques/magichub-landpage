    ...
    <div class="text-center max-w-3xl mx-auto relative z-10 py-12 md:py-16">
      <div class="mb-8 animate-fade-in">
        <h2 class="text-4xl md:text-5xl font-bold mb-6 text-[var(--text)]">
          <span class="text-transparent bg-clip-text bg-gradient-to-r from-[var(--accent)] to-blue-500">80% menos trabalho.</span> 3x mais vendas.
        </h2>
        <p class="text-xl text-[var(--muted)] mb-8 leading-relaxed">
          Deixe a IA enriquecer seu catálogo enquanto você atende seus clientes
        </p>
      </div>
      ...
      <div class="w-full flex justify-center">
        ...
        >
          <span class="text-xl md:text-2xl font-extrabold">Começar grátis (com IA ativa)</span>
      ...
      <div class="mt-8 text-sm text-[var(--muted)] animate-fade-in-delay flex flex-col items-center space-y-1">
