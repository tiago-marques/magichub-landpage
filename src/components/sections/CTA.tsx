  ...
  <Section id="cta" fullScreen>
    ...
    <div class="text-center max-w-4xl mx-auto relative z-10">
      <div class="mb-6 animate-fade-in">
        <h2 class="text-4xl md:text-5xl font-bold mb-4 text-[var(--text)]">
          Pronto para começar?
        </h2>
        <p class="text-xl text-[var(--muted)] mb-8">
          Agende uma demonstração gratuita e veja como é fácil ter seu catálogo digital
        </p>
      </div>
      ...
      <div class="inline-block animate-pulse-soft">
        ...
        >
          <span class="text-xl md:text-2xl font-extrabold">Agendar demo grátis</span>
      ...
      <p class="mt-6 text-sm text-[var(--muted)] animate-fade-in-delay">
