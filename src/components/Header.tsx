    ...
    <header class="fixed inset-x-0 top-0 bg-white z-50 shadow-sm">
      <div class="max-w-6xl mx-auto px-6 sm:px-12 py-4 flex items-center justify-between">
        <a href="/" class="flex items-center gap-3">
          <img src="/src/assets/logo.svg" alt="Magichub" class="h-8" />
        </a>
        ...
        <div>
          <a href="mailto:contato@magichub.com?subject=Agendar%20demo%20Magichub" class="bg-brand text-white px-4 py-2 rounded">Agendar demo</a>
        </div>
      </div>
    </header>
  );
